...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('admin/Festival') }}">Festivals</a></li>
    <li class="active">
        <strong>Add Festival</strong>
    </li>
</ol>
@endsection
    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/festival')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group @if($errors->has('location')) has-error @endif">
                                        ...
                                        <textarea class="form-control" name="location" id="location"
                                            rows="3">@if(count($errors) > 0){{old('location')}}@endif</textarea>
                                            ...
                                            <div class="form-group @if($errors->has('event_date_from')) has-error @endif"">
                                                ...
                                                <div class="input-group date" id="datetimepicker">
                                                    <input id="event_date_from" type="text" name="event_date_from"
                                                        ...
                                                        value="@if(count($errors) > 0){{old('event_date_from')}}@endif" />
                                            ...
                                            <div class="form-group @if($errors->has('event_date_from')) has-error @endif"">
                                                ...
                                                <div class="input-group date" id="datetimepicker2">
                                                    <input id="event_date_to" type="text" name="event_date_to"
                                                        ...
                                                        value="@if(count($errors) > 0){{old('event_date_to')}}@endif" />
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group @if($errors->has('kuota')) has-error @endif">
                                                ...
                                                <input id="kuota" type="number" name="kuota" class="form-control"
                                                    placeholder="Kuota"
                                                    value="@if(count($errors) > 0){{old('kuota')}}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('url')) has-error @endif">
                                        ...
                                        <input id="url" type="text" name="url" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('url')}}@endif" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <img id="image-display"
                                            src="@if(count($errors) > 0){{asset('upload/festival/'. old('foto'))}}@else{{ asset('assets/images/600x400.png') }}@endif"
