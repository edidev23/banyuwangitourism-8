    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/culinary')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <img id="image-display"
                                            src="@if(count($errors) > 0){{asset('upload/culinary/'. old('foto'))}}@else{{ asset('assets/images/600x400.png') }}@endif"
                                            alt="Image Culinary" class="img-thumbnail">
                                    </div>
