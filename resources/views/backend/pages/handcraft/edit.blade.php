...
@section('title', "Edit Handcraft")
@section('bread')
<h2>Edit Handcraft</h2>
<ol class="breadcrumb">
    <li><a href="{{ url('admin') }}">Dashboard</a></li>
    <li><a href="{{ url('admin/handcraft') }}">Handcrafts</a></li>
    <li class="active">
        <strong>Edit Handcraft</strong>
    </li>
</ol>
@endsection
    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/handcraft', $handcraft->id)}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div id="form" class="tab-pane fade in active">
                        ...
                        <div class="tab-content">
                            ...
                            @if(isset($handcraft->handcraftTranslation[$i]->id))
                            {{-- update data --}}
                            <input type="hidden" name="handcraft_translation_id{{ $l->id }}"
                                value="{{ $handcraft->handcraftTranslation[$i]->id }}">
                            <div id="{{ $l->id }}" class="tab-pane fade in @if($l->id == 'ID') active @endif">
                                ...
                                <div class="form-group @if($errors->has('title'.$l->id)) has-error @endif">
                                    ...
                                    <input id="title{{ $l->id }}" type="text" name="title{{ $l->id }}"
                                        ...
                                        value="@if(count($errors) > 0){{old('title'. $l->id )}}@else{{ $handcraft->handcraftTranslation[$i]->title }}@endif" />
                                ...
                                <div class="form-group @if($errors->has('description'.$l->id)) has-error @endif">
                                    ...
                                    <textarea class="form-control" name="description{{ $l->id }}"
                                        id="description{{ $l->id }}"
                                        rows="3">@if(count($errors) > 0){{old('description'. $l->id )}}@else{{ $handcraft->handcraftTranslation[$i]->description }}@endif</textarea>
                                ...
                                <div class="form-group @if($errors->has('address'.$l->id)) has-error @endif">
                                    ...
                                    <textarea class="form-control" name="address{{ $l->id }}" id="address{{ $l->id }}"
                                        rows="3">@if(count($errors) > 0){{old('address'. $l->id )}}@else{{ $handcraft->handcraftTranslation[$i]->address }}@endif</textarea>
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group @if($errors->has('lat')) has-error @endif">
                                        ...
                                        <input id="lat" type="text" name="lat" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('lat')}}@else{{ $handcraft->lat }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('lng')) has-error @endif">
                                        ...
                                        <input id="lng" type="text" name="lng" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('lng')}}@else{{ $handcraft->lng }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('hp')) has-error @endif">
                                        ...
                                        <input id="hp" type="text" name="hp" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('hp')}}@else{{ $handcraft->hp }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('website')) has-error @endif">
                                        ...
                                        <input id="website" type="text" name="website" class="form-control"
                                            placeholder="Website"
                                            value="@if(count($errors) > 0){{old('website')}}@else{{ $handcraft->website }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('youtube')) has-error @endif">
                                        ...
                                        <input id="youtube" type="text" name="youtube" class="form-control"
                                            placeholder="Youtube"
                                            value="@if(count($errors) > 0){{old('youtube')}}@else{{ $handcraft->youtube }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('instagram')) has-error @endif">
                                        ...
                                        <input id="instagram" type="text" name="instagram" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('instagram')}}@else{{ $handcraft->instagram }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('price')) has-error @endif">
                                        ...
                                        <input id="price" type="text" name="price" class="form-control"
                                            placeholder="Price"
                                            value="@if(count($errors) > 0){{old('price')}}@else{{ $handcraft->price }}@endif" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <img id="image-display"
                                            src="@if($handcraft->foto){{ asset('upload/handcraft/'. $handcraft->foto) }}@else{{ asset('assets/images/600x400.png') }}@endif"
                                            alt="{{ $handcraft->foto }}" class="img-thumbnail"
                                    ...
                                    <input type="hidden" name="foto" id="foto"
                                        value="@if(count($errors) > 0){{old('foto')}}@else{{ $handcraft->foto }}@endif">
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="img-container">
                    <div class="row">
                        <div class="col-md-7">
                            <img id="image" src="{{ asset('assets/images/600x400.png')}}" class="img-thumbnail">
                        </div>
                        <div class="col-md-5">
