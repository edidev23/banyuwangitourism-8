    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/destination', $destination->id)}}" method="post"
                    ...
                    <div id="form" class="tab-pane fade in active">
                        ...
                        <div class="tab-content">
                            ...
                            @if(isset($destination->destinationTranslation[$i]->id))
                            {{-- update data --}}
                            <input type="hidden" name="destination_translation_id{{ $l->id }}"
                                value="{{ $destination->destinationTranslation[$i]->id }}">
                            <div id="{{ $l->id }}" class="tab-pane fade in @if($l->id == 'ID') active @endif">
                                ...
                                <div class="form-group @if($errors->has('title'.$l->id)) has-error @endif">
                                    ...
                                    <input id="title{{ $l->id }}" type="text" name="title{{ $l->id }}"
                                        ...
                                        value="@if(count($errors) > 0){{old('title'. $l->id )}}@else{{ $destination->destinationTranslation[$i]->title }}@endif" />
                                ...
                                <div class="form-group @if($errors->has('description'.$l->id)) has-error @endif">
                                    ...
                                    <textarea class="form-control" name="description{{ $l->id }}"
                                        id="description{{ $l->id }}"
                                        rows="3">@if(count($errors) > 0){{old('description'. $l->id )}}@else{{ $destination->destinationTranslation[$i]->description }}@endif</textarea>
                                ...
                                <div class="form-group @if($errors->has('address'.$l->id)) has-error @endif">
                                    ...
                                    <textarea class="form-control" name="address{{ $l->id }}" id="address{{ $l->id }}"
                                        rows="3">@if(count($errors) > 0){{old('address'. $l->id )}}@else{{ $destination->destinationTranslation[$i]->address }}@endif</textarea>
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group @if($errors->has('lat')) has-error @endif">
                                        ...
                                        <input id="lat" type="text" name="lat" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('lat')}}@else{{ $destination->lat }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('lng')) has-error @endif">
                                        ...
                                        <input id="lng" type="text" name="lng" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('lng')}}@else{{ $destination->lng }}@endif" />
                                    ...
                                    <div
                                        ...
                                        <select name="destination_category_id" id="destination_category_id"
                                            ...
                                            <option value="{{ $cat->destination_category_id }}" @if((count($errors)> 0
                                                ...
                                                $cat->destination_category_id == $destination->destination_category_id)
                                    ...
                                    <div class="form-group @if($errors->has('hp')) has-error @endif">
                                        ...
                                        <input id="hp" type="text" name="hp" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('hp')}}@else{{ $destination->hp }}@endif" />
                                    ...
                                    <div class="form-group @if($errors->has('verified')) has-error @endif">
                                        ...
                                        <select name="verified" id="verified" class="form-control">
                                            ...
                                            <option value="verified" @if((count($errors)> 0 && old('verified') ==
                                                'verified') || $destination->verified == 'verified') selected
                                                @endif>Verified</option>
                                            <option value="belum verified" @if((count($errors)> 0 && old('verified') ==
                                                'belum verified') || $destination->verified == 'belum verified')
                                                selected @endif>Belum Verified</option>
                                        </select>
                                    ...
                                    <div class="form-group @if($errors->has('view_360')) has-error @endif">
                                        ...
                                        <input id="view_360" type="text" name="view_360" class="form-control"
                                            ...
                                            value="@if(count($errors) > 0){{old('view_360')}}@else{{$destination->view_360}}@endif" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <img id="image-display"
                                            src="@if($destination->foto){{ asset('upload/destination/'. $destination->foto) }}@else{{ asset('assets/images/600x400.png') }}@endif"
                                            alt="{{ $destination->foto }}" class="img-thumbnail"
                                    ...
                                    <input type="hidden" name="foto" id="foto"
                                        value="@if(count($errors) > 0){{old('foto')}}@else{{ $destination->foto }}@endif">
                                </div>
                            </div>
