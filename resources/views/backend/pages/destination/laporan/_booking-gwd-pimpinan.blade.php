...
@section('bread')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><strong>Bulanan</strong></li>
    </ol>
@endsection
        ...
        <div class="col-lg-12">
            <div class="inqbox">
                ...
                <div class="inqbox-content">
                    <div class="row">
                        <div class="col-md-3">
                            <form action="{{ url('admin/laporan-tiket-gwd') }}" method="get">
                                <div style="margin-bottom: 10px; margin-left: 0; display: flex">
                                    <div class="datepicker" style="flex: 3">
                        ...
                        <table class="table table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="100px">Tanggal</th>
                                    <th>Glass Bottom</th>
                                    <th>Tiket Glass Bottom</th>
                                    <th>Mandi Bola</th>
                                    <th>Tiket Mandi Bola</th>
                                    <th>Kano</th>
                                    <th>Tiket Kano</th>
                                </tr>
                            </thead>
