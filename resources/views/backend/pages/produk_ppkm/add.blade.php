...
@section('title', 'Add Produk PPKM')
@section('bread')
<h2>Add Produk PPKM</h2>
<ol class="breadcrumb">
    <li><a href="{{ url('admin') }}">Dashboard</a></li>
    <li><a href="{{ url('admin/handcraft') }}">Produk PPKM</a></li>
    <li class="active">
        <strong>Add Produk PPKM</strong>
    </li>
</ol>
@endsection
    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{ url('admin/produk_ppkm') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group @if ($errors->has('category')) has-error @endif">
                                    ...
                                    <select class="form-control" id="category" name="category">
                                        ...
                                        <option value="makanan" @if (count($errors) > 0 && old('category') == 'makanan') selected @endif>Makanan & Minuman</option>
                                        <option value="kerajinan" @if (count($errors) > 0 && old('category') == 'kerajinan') selected @endif>Kerajinan</option>
                                    </select>
                                ...
                                <div class="form-group @if ($errors->has('description')) has-error @endif">
                                    ...
                                    <textarea class="form-control" name="description"
                                        rows="3">@if (count($errors) > 0) {{ old('description') }} @endif</textarea>
                                ...
                                <div class="form-group @if ($errors->has('address')) has-error @endif">
                                    ...
                                    <textarea class="form-control" name="address"
                                        rows="3">@if (count($errors) > 0) {{ old('address') }} @endif</textarea>
                                ...
                                <div class="form-group @if ($errors->has('whatsapp')) has-error @endif">
                                    ...
                                    <input id="whatsapp" type="text" name="whatsapp" class="form-control"
                                        placeholder="Whatsapp" value="@if (count($errors)> 0) {{ old('whatsapp') }} @endif" />
                                ...
                                <div class="form-group @if ($errors->has('website')) has-error @endif">
                                    ...
                                    <input id="website" type="text" name="website" class="form-control"
                                        placeholder="Website" value="@if (count($errors)> 0) {{ old('website') }} @endif" />
                                ...
                                <div class="form-group @if ($errors->has('instagram')) has-error @endif">
                                    ...
                                    <input id="instagram" type="text" name="instagram" class="form-control"
                                        placeholder="instagram" value="@if (count($errors)> 0) {{ old('instagram') }} @endif" />
                                ...
                                <div class="form-group @if ($errors->has('facebook')) has-error @endif">
                                    ...
                                    <input id="facebook" type="text" name="facebook" class="form-control"
                                        placeholder="Facebook" value="@if (count($errors)> 0) {{ old('facebook') }} @endif" />
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="image-foto" style="display: block">Image Produk (*)</label>
                                    <img id="image-display" src="@if (count($errors)> 0 &&
                                    old('foto') != '') {{ asset('upload/produk_ppkm/' . old('foto')) }}@else{{ 'https://via.placeholder.com/580x700' }} @endif"
                                ...
                                <input type="hidden" name="foto" id="foto" value="@if (count($errors)> 0) {{ old('foto') }} @endif">
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="img-container">
                    <div class="row">
                        <div class="col-md-7">
                            <img id="image" src="https://via.placeholder.com/580x700">
                        </div>
                        <div class="col-md-5">
