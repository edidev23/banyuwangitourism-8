    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/geopark-destination', $geopark_destination->id)}}" method="post"
                        ...
                        <div class="col-lg-8">
                            <div class="form-group @if($errors->has('title')) has-error @endif">
                                ...
                                <input id="title" type="text" name="title" class="form-control"
                                    placeholder="Title"
                                    value="@if(count($errors) > 0){{old('title')}}@else{{$geopark_destination->title}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('description')) has-error @endif">
                                ...
                                <input id="description" type="text" name="description" class="form-control"
                                    ...
                                    value="@if(count($errors) > 0){{old('description')}}@else{{$geopark_destination->description}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('text')) has-error @endif">
                                ...
                                <textarea class="ckeditor" name="text" id="text">@if(count($errors) > 0){{old('text')}}@else{{$geopark_destination->text}}@endif</textarea>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <img id="image-display"
                                    src="@if($geopark_destination->foto){{ asset('upload/geopark-destination/'. $geopark_destination->foto) }}@else{{ asset('assets/images/600x400.png') }}@endif"
                                    alt="{{ $geopark_destination->foto }}" class="img-thumbnail"
                            ...
                            <input type="hidden" name="foto" id="foto"
                                value="@if(count($errors) > 0){{old('foto')}}@else{{ $geopark_destination->foto }}@endif">
                        </div>
                    </div>
            ...
            reader.onloadend = function() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'image': base64data,
                        'destination_id': {{ $geopark_destination->id }}
                    },
