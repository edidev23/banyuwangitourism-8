                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-group @if($errors->has('role')) has-error @endif">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    <option value="admin" @if(count($errors)> 0 && old('role') == 'admin') selected
                                        @endif>Administrator
                                    </option>
                                    <option value="content" @if(count($errors)> 0 && old('role') == 'content') selected
                                        @endif>Content
                                        Writer</option>
                                    <option value="operator" @if(count($errors)> 0 && old('role') ==
                                        'operator') selected @endif>Operator
                                    </option>
                                    <option value="pimpinan" @if(count($errors)> 0 && old('role') ==
                                        'pimpinan') selected @endif>Pimpinan
                                    </option>
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <img id="image-display"
                                    src="@if(count($errors) > 0 && old('foto') != ''){{asset('upload/user/large/'. old('foto'))}}@else{{ asset('assets/images/600x400.png') }}@endif"
                                    alt="Image user" class="img-thumbnail">
                            </div>
