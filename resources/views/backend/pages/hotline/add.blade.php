...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('admin/hotline') }} ">Hotline</a></li>
    <li class="active">
        <strong>Add Hotline</strong>
    </li>
</ol>
@endsection
    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/hotline')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group @if($errors->has('category')) has-error @endif">
                                ...
                                <input id="category" type="text" name="category" class="form-control"
                                    ...
                                    value="@if(count($errors) > 0){{old('category')}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('category_name')) has-error @endif">
                                ...
                                <input id="category_name" type="text" name="category_name" class="form-control"
                                    ...
                                    value="@if(count($errors) > 0){{old('category_name')}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('phone')) has-error @endif">
                                ...
                                <input id="phone" type="text" name="phone" class="form-control"
                                    placeholder="Phone Hotline" value="@if(count($errors) > 0){{old('phone')}}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <img id="image-display"
                                    src="@if(count($errors) > 0 && old('foto') != ''){{asset('upload/hotline/'. old('foto'))}}@else{{ asset('assets/images/600x400.png') }}@endif"
                                    alt="Image Hotline" class="img-thumbnail">
                            </div>
