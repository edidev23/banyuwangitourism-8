                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Culinary</h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            <h3 class="title font-size-24">Culinary Majestic Banyuwangi</h3>
                            <p class="font-size-16 line-height-20 pt-1">Berikut ini makanan yang disukai wisatawan saat liburan ke Banyuwangi.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-6 responsive-column">
                        <div class="card-item ">
                            <div class="card-img">
                                <a href="{{ url('culinary/'. $cul->slug) }}" class="d-block">
                                    <img src="{{ asset('upload/culinary/'. $cul->foto) }}" alt="{{ $cul->title }}">
                                </a>
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="{{ url('culinary/'. $cul->slug) }}">{{ $cul->title }}</a></h3>
                                <p class="card-meta mb-3"><i class="las la-map-marker-alt mr-1"></i>  {{ $cul->address }}</p>
                                <div class="card-price d-flex align-items-center justify-content-between">
                                    <p>
                                        @if($cul->price != '')
                                            <span class="price__num">{{ rupiah($cul->price) }}</span>
                                        @endif
                                        <span class="price__text">
                                            <a href="call:{{ $cul->hp }}"> <i class="la la-phone mr-1"></i>{{ $cul->hp }} </a>
                                        </span>
                                        
                                    </p>
                                    <a href="{{ url('culinary/'. $cul->slug) }}" class="btn-text">See details<i class="la la-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
