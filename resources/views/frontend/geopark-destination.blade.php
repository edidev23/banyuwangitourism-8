                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Geopark Destination</h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            <h3 class="title font-size-24">Geopark Destination</h3>
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-6 responsive-column">
                        <div class="card-item ">
                            <div class="card-img">
                                <a href="{{ url('geopark/'. $des->slug) }}" class="d-block">
                                    <img src="{{ asset('upload/geopark-destination/'. $des->foto) }}" alt="{{ $des->title }}">
                                </a>
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><a href="{{ url('geopark/'. $des->slug) }}">{{ $des->title }}</a></h3>
                                <p class="card-meta"> {{ $des->description }}</p>
                                <div class="card-price d-flex align-items-center justify-content-between">
                                    <a href="{{ url('geopark/'. $des->slug) }}" class="btn-text">See details<i class="la la-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
